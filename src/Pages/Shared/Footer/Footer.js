...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-2 bg-gray-900 text-yellow-500-content rounded-lg">
                <div>
                    <img className='m-7' src='https://vroom.com.bd/wp-content/uploads/2022/09/v.logo_.247.white_.may20-165x31.png' alt="" />
                    <Link className=' font-semibold text-2xl' to='/'><span className='text-cyan-400'>VRO</span><span className='text-yellow-500'>OM 24<small>x</small>7</span> <span className='text-white'>BaNgLaDeSh</span></Link>
